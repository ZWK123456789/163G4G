...
<body>
	<div class="marginLayout">
		<form action="question/Question_addWrittenQuestion" method="post" name="formAddQuestion"
			...
			<input type="hidden" name="course.stage" value="${param.stage }">
			<%-- <input type="hidden" name="written.csId" value="${param.csId }"> --%>
			<table class="marginLayout">
				...
				<tr>
					...
					<td>
						<select id="qtype" name="written.qtype" onchange="changeOptionType()">
				...
				<tr>
					...
					<td>
						<textarea rows="3" cols="30" name="written.qtitle" id="qTitle"></textarea>
					</td>
				</tr>
				<tr>
					<td align="right"><font>题目选项:</font></td>
					<td>
						<input type="radio" class="options" name="written.answer" value="A" checked="checked">A
						<input class="textWidth" type="text" name="written.optionA" id="optionA">
						<br />
						<input type="radio" class="options" name="written.answer" value="B">B
						<input class="textWidth" type="text" name="written.optionB" id="optionB">
						<br />
						<input type="radio" class="options" name="written.answer" value="C">C
						<input class="textWidth" type="text" name="written.optionC" id="optionC">
						<br />
						<input type="radio" class="options" name="written.answer" value="D">D
						<input class="textWidth" type="text" name="written.optionD" id="optionD">
						<br />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input class="textWidth" type="text" name="written.chapter" id="chapter">
					</td>
				</tr>
				<tr>
